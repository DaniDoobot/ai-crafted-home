    ...
    <section className="relative overflow-hidden bg-[#080C24] pt-32 pb-20 lg:pt-36 lg:pb-28 text-white min-h-[700px] flex items-center">
      ...
      <div className="relative mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
          ...
          {/* ── Right: Enlarge New AI Analytics Hero Image Visual (+18%) ── */}
          <div className="lg:col-span-6">
            <div className="relative mx-auto max-w-[590px]">
              {/* Violet Glow Behind Frame */}
              <div className="absolute -inset-4 rounded-[32px] bg-gradient-to-tr from-indigo-500/25 via-violet-500/20 to-blue-500/15 blur-2xl opacity-75" />
