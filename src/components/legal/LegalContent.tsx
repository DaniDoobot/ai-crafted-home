import { Building2, Mail, MapPin, Phone, FileCheck } from "lucide-react";
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-b from-[#F8FAFC] via-[#F3F0FF]/30 to-white">
      <div className="mx-auto max-w-[920px] px-4 sm:px-6 lg:px-8">
        <LegalNavigation currentPath="/aviso-legal/" />
        ...
        <div className="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-10 shadow-sm space-y-10 text-slate-700">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-indigo-100 bg-indigo-50/40 p-5 sm:p-6 space-y-3.5 text-[15px] sm:text-[16px]">
              ...
              <div className="border-t border-indigo-200/60 pt-3 text-[14px] text-slate-600">
                <span className="font-semibold text-slate-800">Datos registrales:</span> Inscrita en el Registro Mercantil de Madrid; Tomo 28285; Libro 0; Fecha 22 de Noviembre de 2010.
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 border-t border-slate-100 pt-8">
            <h2 className="font-display font-bold text-[#050547] text-lg sm:text-xl tracking-tight flex items-center gap-2.5">
              ...
              PROTECCIÓN DE DATOS Y POLÍTICAS COMPLEMENTARIAS
            </h2>
            <p className="text-[16.5px] sm:text-[17px] leading-[1.7] text-slate-600">
              Customernet Soluciones de Negocio S.L. garantiza el pleno cumplimiento de la normativa europea de protección de datos (RGPD UE 2016/679) y la Ley Orgánica 3/2018 (LOPDGDD). Para conocer en detalle el tratamiento de sus datos personales, la gestión de cookies o nuestro compromiso de seguridad, consulte nuestras políticas correspondientes:
            </p>
            <ul className="mt-3 flex flex-col gap-2 pl-4 text-[15px] font-medium text-indigo-700">
              <li>
                <a href="/politica-de-privacidad/" className="hover:underline flex items-center gap-2">
                  <span>→</span> Política de privacidad
                </a>
              </li>
              <li>
                <a href="/politica-de-seguridad-de-la-informacion/" className="hover:underline flex items-center gap-2">
                  <span>→</span> Política de seguridad de la información (ISO/IEC 27001)
                </a>
              </li>
              <li>
                <a href="/politica-de-cookies/" className="hover:underline flex items-center gap-2">
